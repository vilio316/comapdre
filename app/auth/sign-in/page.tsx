  ...
  return (
    <div className="mx-auto max-w-md px-4 py-10 sm:py-16">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-deep sm:text-3xl">Welcome back</h1>
        <p className="mt-1 text-sm text-ink-muted">Sign in to your Compadre account.</p>
      </div>
      ...
      <p className="mt-6 text-center text-xs text-ink-muted">
        ...
        <Link href="/auth/sign-up" className="font-medium text-blue underline hover:text-blue-light">
          Sign up
        </Link>
      </p>
    </div>
