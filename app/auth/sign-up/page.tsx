  ...
  return (
    <div className="mx-auto max-w-md px-4 py-10 sm:py-16">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-deep sm:text-3xl">Create your account</h1>
        <p className="mt-1 text-sm text-ink-muted">Start studying smarter with Compadre.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div>
          <label className="mb-1 block text-sm font-medium text-ink-muted">Confirm password</label>
          <input
            type="password"
            value={confirm}
      ...
      <p className="mt-6 text-center text-xs text-ink-muted">
        ...
        <Link href="/auth/sign-in" className="font-medium text-blue underline hover:text-blue-light">
          Sign in
        </Link>
      </p>
    </div>
